...
<head>
    <meta charset="utf-8" />
    <title>Pizzaria Labella Pizza</title>
...
<body>
    <div class="models">
        ...
        <div class="cart--item">
            <img src="" style="width: max-content;" />
    ...
    <div class="pizzaWindowArea"> <!--Modal--> 
    ...
    <button class="pizzaFeedback--Button">Abrir Formulário:</button>
